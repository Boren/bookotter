    ...
    <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-stone-900 shadow-warm-xl">
      ...
      <div class="px-4 py-4 border-t border-stone-800">
        <div
          ...
          :class="syncStore.isRunning ? 'bg-ereader-900/30' : 'bg-stone-800/50'"
        >
          <div class="relative">
            <span
              class="status-dot"
              :class="syncStore.isRunning ? 'bg-ereader-400 animate-pulse' : 'status-dot-success'"
            ></span>
          </div>
          ...
          <div v-if="syncStore.isRunning" class="text-ereader-400">
      ...
      <div class="flex items-center justify-between h-16 px-4">
        ...
        <div class="flex items-center gap-3">
          <div class="flex items-center gap-2 text-sm">
            <span
              class="status-dot"
              :class="syncStore.isRunning ? 'bg-ereader-500 animate-pulse' : 'status-dot-success'"
            ></span>
